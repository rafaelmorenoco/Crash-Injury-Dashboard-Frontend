...
<Grid cols=2>
    <Group>
        ...
        />
        <Areas data={smd_map} geoJsonUrl='./static/smd_2023.geojson' geoId=SMD areaCol=SMD value=Injuries link=link min=0 opacity=0.7 borderWidth=1 borderColor='#A9A9A9'/>
        </BaseMap>
        <Note>
