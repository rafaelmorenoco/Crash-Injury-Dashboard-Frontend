...
<Grid cols=2>
    <Group>
        ...
        />
        <Areas data={anc_map} geoJsonUrl='./static/anc_2023.geojson' geoId=ANC areaCol=ANC value=Injuries link=link min=0 opacity=0.7 borderWidth=1 borderColor='#A9A9A9'/>
        </BaseMap>
        <Note>
